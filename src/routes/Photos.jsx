...
const Photos = () => {
  ...
  useEffect(() => {
    ...
    async function fetchAllSorted () {
      const res = await fetch(`https://gallery-app-server.vercel.app/photos?_sort=id&_order=${sort}`);
      const data = await res.json();
      // console.log(data);
      setPhotos(data);
      setLoading(false);
  ...
  useEffect(() => {
    ...
    async function fetchSearch () {
      const res = await fetch(`https://gallery-app-server.vercel.app/photos?q=${submited}`);
      const data = await res.json();
      console.log(data);
      setPhotos(data);
      setLoading(false);
